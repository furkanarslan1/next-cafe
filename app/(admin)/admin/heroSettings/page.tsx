...
const heroSettingsCards = [
  ...
  },
  {
    title: "Drinks Hero",
    description:
      "Update the hero image, title and description for the drinks page.",
  ...
  },
  {
    title: "Meals Hero",
    description:
      "Update the hero image, title and description for the meals page.",
  ...
  },
  {
    title: "Desserts Hero",
    description:
      "Update the hero image, title and description for the desserts page.",
    ...
    <div className="max-w-4xl mx-auto my-16 px-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {heroSettingsCards.map((card) => (
          ...
          >
            <div className={`p-2 bg-linear-to-br ${card.gradient} rounded-xl`}>
